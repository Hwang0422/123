...
!function(e){
    e.fn.poptrox_disableSelection=function(){
        ...
        function t(){
            ...
            var o=Math.abs(x.width()-x.outerWidth()),t=Math.abs(x.height()-x.outerHeight()),p=(w.width(),w.height(),i-2*r.windowMargin-o),n=s-2*r.windowMargin-t;
            ...
            if("ignore"!=n&&i.attr("href")){
                if(t={src:i.attr("href"),captionText:s.attr("title"),width:null,height:null,type:null,object:null,options:null},r.caption){
                    if("function"==typeof r.caption)c=r.caption(i);
                      ...
                      ("selector"in r.caption){
                          var a;a=i.find(r.caption.selector),"attribute"in r.caption?c=a.attr(r.caption.attribute):(c=a.html(),r.caption.remove===!0&&a.remove())
                        }
                    }
                    else 
                    c=s.attr("title");
